...
Usage:
    ...
    python -m agents.deep_search_v4.reg_compliance_search.populate_sectors --dry-run

    # Run for real — update DB in batches of 20
    python -m agents.deep_search_v4.reg_compliance_search.populate_sectors

    # Limit to N regulations (useful for testing)
    python -m agents.deep_search_v4.reg_compliance_search.populate_sectors --limit 10
"""
