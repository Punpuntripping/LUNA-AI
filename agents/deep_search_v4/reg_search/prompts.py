...
نتائج البحث بتنسيق markdown. كل نتيجة **مقطع** (chunk) من نظام أو لائحة، ويحمل:
- معرّفاً قصيراً ثابتاً `### [Cn]` — استخدمه وحده للإشارة إلى المقطع في قراراتك
- **النظام**: اسم النظام أو اللائحة الأم
- **نطاق النظام**: نطاق تطبيق النظام الأم — على مَن ومتى وأين يسري
- **ملخص المقطع**: ملخص محتوى المقطع
- وقد يحمل أيضاً **سياق المقطع السابق / الحالي / التالي**: موضع المقطع داخل النظام
