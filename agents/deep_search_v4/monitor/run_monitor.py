...
def _write_readme(
    ...
    lines = [
        ...
        "  for DCR / `prompt_dcr_fallback.md` if a DCR stage raised /",
        "  `prompt_correction.md` if the primary failed a hard validator gate)",
        "  -- exact system prompt + user message sent to the LLM, byte-for-byte",
