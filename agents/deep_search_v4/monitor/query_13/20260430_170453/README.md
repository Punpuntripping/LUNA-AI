# Monitor session -- query_id=13

- **status**: OK
- **wall_time_s**: 249.72
- **category**: عمالي - إنهاء عقد وتعويض
- **confidence**: medium
- **references**: 9
...
| 10 | [10_reg_search/](10_reg_search/) | Reg phase mirror -- expander + search + reranker. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\reg_search\reports\query_13\20260430_170514`* |
...
| 30 | [30_case_search/](30_case_search/) | Case phase mirror. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\case_search\reports\query_13\20260430_170515`* |
