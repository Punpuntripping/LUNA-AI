# Monitor session -- query_id=5

- **status**: CRASHED
- **wall_time_s**: 86.84
- **category**: عمالي - إنهاء عقد سائق
- **confidence**: -
- **references**: 0
...
| 10 | [10_reg_search/](10_reg_search/) | Reg phase mirror -- expander + search + reranker. *FAILED -- log dir was not captured (phase may have crashed before logger init) (rqr_table.md still written)* |
| 20 | [20_compliance_search/](20_compliance_search/) | Compliance phase mirror. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v4\compliance_search\reports\query_5\20260503_164017`* |
...
See [CRASH.md](CRASH.md). Error: `AttributeError: 'ExpanderOutput' object has no attribute 'sectors'`
