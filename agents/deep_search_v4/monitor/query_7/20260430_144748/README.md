...
| 10 | [10_reg_search/](10_reg_search/) | Reg phase mirror -- expander + search + reranker. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\reg_search\reports\query_7\20260430_144801`* |
...
See [CRASH.md](CRASH.md). Error: `ValidationError: 1 validation error for AggregatorOutput
validation
