# Monitor session -- query_id=16

- **status**: OK
- **wall_time_s**: 843.07
- **category**: عمالي - نهاية خدمة ومماطلة
- **confidence**: medium
- **references**: 12
...
| 10 | [10_reg_search/](10_reg_search/) | Reg phase mirror -- expander + search + reranker. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\reg_search\reports\query_16\20260430_140155`* |
| 20 | [20_compliance_search/](20_compliance_search/) | Compliance phase mirror. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\compliance_search\reports\query_16\20260430_140203`* |
| 30 | [30_case_search/](30_case_search/) | Case phase mirror. *OK -- mirrored from `C:\Programming\LUNA_AI\agents\deep_search_v3\case_search\reports\query_16\20260430_140203`* |
