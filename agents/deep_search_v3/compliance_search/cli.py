...
Usage:
    python -m agents.deep_search_v3.compliance_search.cli "your Arabic query here"
    python -m agents.deep_search_v3.compliance_search.cli                          # uses default test query
    python -m agents.deep_search_v3.compliance_search.cli --rerank "query"         # enable Jina reranker
    python -m agents.deep_search_v3.compliance_search.cli --mock "query"           # use mock results
    python -m agents.deep_search_v3.compliance_search.cli --verbose "query"        # extra debug info
    python -m agents.deep_search_v3.compliance_search.cli --list-logs              # list recent run logs
    python -m agents.deep_search_v3.compliance_search.cli --read-log LOG_ID        # read a specific log
"""
