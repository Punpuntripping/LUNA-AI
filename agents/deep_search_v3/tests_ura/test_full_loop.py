...
Usage:
    python -m agents.deep_search_v3.test_full_loop
    python -m agents.deep_search_v3.test_full_loop --query-ids 1 5 10 28
    python -m agents.deep_search_v3.test_full_loop --count 5
"""
...
async def run_one(query_id: int, query_text: str, deps) -> dict:
    from agents.deep_search_v3.orchestrator import run_full_loop
...
async def main() -> None:
    ...
    from agents.deep_search_v3.orchestrator import FullLoopDeps
