...
Usage:
    python -m agents.deep_search_v3.test_compliance_ura
    python -m agents.deep_search_v3.test_compliance_ura --query-id 5
    python -m agents.deep_search_v3.test_compliance_ura --live   # real DB
"""
...
def _build_mock_partial_ura(query_id: int, query_text: str):
    ...
    from agents.deep_search_v3.ura.schema import PartialURA, URAResult
...
async def run_mock_test(query_id: int) -> None:
    ...
    from agents.deep_search_v3.compliance_search.models import ComplianceSearchDeps
    from agents.deep_search_v3.compliance_search.ura_runner import run_compliance_from_partial_ura
