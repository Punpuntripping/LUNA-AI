...
export const AUDIENCES_PAGE = {
  ...
  subtitle:
    "قاعدة ريحان تغطّي أنظمة وأحكام وخدمات كل القطاعات في المملكة — فأينما تقاطع عملك مع نظام سعودي، يجد لك ريحان مصدره الرسمي ويربط كل معلومة برابطها المباشر.",
} as const;
...
export const AUDIENCES: Audience[] = [
  ...
  },
  {
    ...
    basis:
      "نظام العمل والأحوال الشخصية ولوائح التأمين والتعاملات المصرفية وخدمات وزارة العدل الرسمية.",
  },
];
