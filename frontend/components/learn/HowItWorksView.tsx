...
const SEARCH_SCOPES = [
  {
    icon: BookOpenText,
    title: "وكيل الأنظمة والامتثال",
    body: "يبحث في الأنظمة واللوائح والأدلة التنظيمية والخدمات الحكومية والتعاميم، ويشمل ذلك فحص الالتزام: متطلبات الجهات الرقابية والاشتراطات والتراخيص التي تنطبق على نشاطك.",
  },
  {
    icon: Scale,
