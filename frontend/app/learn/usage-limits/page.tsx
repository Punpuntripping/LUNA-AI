...
const DESCRIPTION =
  "ريحان يحاسبك بالنقطة لا بعدد الرسائل: البحث المعمّق ٣–٥ نقاط، صياغة المستند نقطة واحدة، والسؤال العام جزء من نقطة. أرقام مقاسة على استخدام حقيقي، مع ما تتيحه كل باقة في الجلسة والأسبوع.";
