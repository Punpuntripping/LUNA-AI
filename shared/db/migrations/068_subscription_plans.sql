...
--   free                  100      50      20       0        0        —
--   basic (أسبوعي)        —        200     —        40       40       7d
--   pro                   500      200     50       40       40       —
--   max                   1600     400     100      200      200      —
...
VALUES
    ...
    ('basic',                'الأساسية',      'Basic',                NULL, 200,  NULL, 40,   40,   7),
    ('pro',                  'الاحترافية',    'Pro',                  500,  200,  50,   40,   40,   NULL),
    ('max',                  'القصوى',        'Max',                  1600, 400,  100,  200,  200,  NULL),
